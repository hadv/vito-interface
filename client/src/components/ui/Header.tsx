...
import { MessageSigningModal } from './MessageSigningModal';
...
const Header: React.FC<HeaderProps> = ({
  ...
  const [showMessageSigningModal, setShowMessageSigningModal] = useState(false);
  ...
  return (
    <header className={headerClasses}>
        ...
        {walletConnected && connectionState.isConnected && (
          <div className="h-full flex items-center px-4 relative">
            ...
            <button
              ...
              title="WalletConnect"
              className="w-8 h-8 flex items-center justify-center hover:bg-gray-700/50 transition-colors rounded mr-2"
            >
              <svg
                width="28"
                height="28"
            ...
            <button
              onClick={() => setShowMessageSigningModal(true)}
              title="Pending Message Signatures"
                    ...
                    <div className="flex-1">
                      <div className="text-white font-semibold text-sm">
                        {connectionState.walletType === 'walletconnect' ? 'WalletConnect' :
                         connectionState.walletType === 'web3auth' ? 'Web3Auth' : 'MetaMask'}
                      </div>
      ...
      <MessageSigningModal
        isOpen={showMessageSigningModal}
        onClose={() => setShowMessageSigningModal(false)}
      />
    </header>
  );
};
